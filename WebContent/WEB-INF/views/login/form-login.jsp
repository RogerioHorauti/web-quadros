...
<div class="container-fluid larguraContent">
    ...
    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-04 ">
                    <form role="form" style="width: 300px; margin: 0 auto;" method="POST" action="efetuarLogin">
                        <div class="form-group">
                            <legend>
                              <h4 style="text-align: center">Se já possui uma conta, informe os dados de acesso.</h4>
                            </legend>
                            <input class="form-control animated" id="inputLogin" placeholder="Usuário" type="text" name="login">
                            <input class="form-control animated" id="inputSenha" placeholder="Senha" type="password" name="senha">
                        </div>
                       
                        <button type="submit" class="btn btn-block btn-sm btn-primary">Entrar</button>
                    </form>
                </div>
            </div>
        </div>
